...
- (void)applicationDidFinishLaunching:(NSNotification*)aNotification {
    ...
    int dpi_scale = _sapp.desc.high_dpi ? 2 : 1;
    _sapp.dpi_scale = (float) dpi_scale;
    _sapp.framebuffer_width = dpi_scale * _sapp.window_width;
    _sapp.framebuffer_height = dpi_scale * _sapp.window_height;
